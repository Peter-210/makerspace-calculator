/**
 * @file makerspace_constexpr.h
 * @brief This file contains all constexpr functions related to 
 * namespace Makerspace and it's calculations and UI
 */

#ifndef MAKERSPACE_CONSTEXPR_H
#define MAKERSPACE_CONSTEXPR_H
